...
def get_args():
    ...
    parser.add_argument('--input_dim', default=3*6, type=int, help='dimensionality of input tensor')  # Updated for 3D
    parser.add_argument('--hidden_dim', default=200, type=int, help='hidden dimension of mlp') # increased from 200
